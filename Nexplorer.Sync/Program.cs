...
namespace Nexplorer.Sync
{
    internal class Program
    {
        ...
        private static void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<NexusDb>(x => x.UseSqlServer(configuration.GetConnectionString("NexusDb"), y =>
            {
                y.MigrationsAssembly("Nexplorer.Data");
                y.CommandTimeout((int)TimeSpan.FromMinutes(10).TotalSeconds);
