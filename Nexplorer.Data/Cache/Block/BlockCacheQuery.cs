...
{
    public class BlockCacheQuery
    {
        private readonly RedisCommand _redisCommand;
        private List<BlockDto> _cache;

        public BlockCacheQuery(RedisCommand redisCommand)
        {
        ...
        public Task<CachedAddressDto> GetCachedAddressAsync(string hash)
        {
            return _redisCommand.GetAsync<CachedAddressDto>(Settings.Redis.BuildCachedAddressKey(hash));
        }

        public Task<List<BlockLiteDto>> GetBlockLiteCacheAsync()
        {
            return _redisCommand.GetAsync<List<BlockLiteDto>>(Settings.Redis.BlockLiteCache);
        }

        public Task<List<TransactionLiteDto>> GetTransactionLiteCacheAsync()
        {
