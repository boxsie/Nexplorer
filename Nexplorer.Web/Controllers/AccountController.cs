...
namespace Nexplorer.Web.Controllers
{
    ...
    public class AccountController : WebControllerBase
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            {
                var result = await _signInManager.PasswordSignInAsync(model.SignInUsername, model.SignInPassword, model.RememberMe, lockoutOnFailure: false);
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await _emailSender.SendEmailConfirmationAsync(model.Email, model.Username, callbackUrl);
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            var email = new EmailMessage(new EmailAddress { Address = model.Email, Name = model.Username })
            {
